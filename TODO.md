...
- [x] T212: Fix bar graph visuals — DONE. filter+viewmode interaction fixed. Mobile verification available locally (`node scripts/verify-dashboard-mobile.js`). CI integration deferred — requires Chrome + proxy startup in Actions, not justified for project size.
