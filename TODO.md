...
- [ ] T124: Cost optimization widget — explain the math inline. Currently shows "14 restarts, $32.64 cache write, $2.33 saved per fewer restart" with no context. Add explanatory subtitle or info icon: "Each new session writes full context to prompt cache (~$2.33). Fewer restarts = less cache_write spend. Formula: total_cache_write_cost / restart_count = cost_per_restart."
